package com.demo.image.convert;


import com.demo.image.util.AnimatedGifEncoder;
import com.demo.image.util.Base64Util;
import com.demo.image.zoom.ImageHelper;
...
public class ImageToChar {
	 ...
	 * @throws IOException
	 */
	public static void loadIMage(String imagePath, String outPath, String text, int number, int color)
			throws IOException {
		base = text;
		speed = number;
		isColor = color;
	 ...
	 * @throws IOException
	 */
	public static void loadGif(String imagePath, String outPath, String text, int number, int color)
			throws IOException {
		base = text;
		speed = number;
		isColor = color;
		...
		jpgToGif(bufferedImages, outPath, 200);
	}
